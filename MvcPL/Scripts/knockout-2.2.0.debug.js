...
ko.dependentObservable = function (evaluatorFunctionOrOptions, evaluatorFunctionTarget, options) {
    ...
    function evaluateImmediate() {
        ...
        try {
            ...
            // For each subscription no inter being used, remove it from the active subscriptions list and dispose it
...
ko.expressionRewriting = (function () {
    ...
    function restoreTokens(string, tokens) {
        var prevValue = null;
        while (string != prevValue) { // Keep restoring tokens until it no inter makes a difference (they may be nested)
            prevValue = string;
...
(function() {
    ko.jqueryTmplTemplateEngine = function () {
        ...
        // which KO internally refers to as version "2", so older versions are no inter detected.
