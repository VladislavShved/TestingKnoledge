...
intellisense.annotate(jQuery.fn, {
  ...
  'die': function() {
    ...
    /// <signature>
    ///   <summary>Remove an event handler previously attached using .live() from the elements.</summary>
    ///   <param name="eventTypes" type="Object">A map of one or more event types, such as click or keydown and their corresponding functions that are no inter to be executed.</param>
    ///   <returns type="jQuery" />
    /// </signature>
  },
  'disabled': function() {
  ...
  'trigger': function() {
    ...
    ///   <param name="extraParameters" type="Object">Additional parameters to pass aint to the event handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given event type.</summary>
